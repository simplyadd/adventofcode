...
parser.add_argument('--console', default='INFO', help='Set the logging level (e.g., DEBUG, INFO, WARNING, ERROR, CRITICAL)')
parser.add_argument('--logFile', default='build.log', help='*.log file name')
args = parser.parse_args()

log_level = getattr(logging, args.log.upper(), None)
console_level = getattr(logging, args.console.upper(), None)
